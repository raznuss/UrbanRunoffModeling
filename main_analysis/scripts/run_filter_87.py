...
output_path = os.path.join(output_dir, "efrat_row_discharge_results_highurbanization_level.csv")
...
if event_col is not None:
    ...
    summary_output_path = os.path.join(output_dir, "efrat_event_stats_highurbanization.csv")
